...
import org.vamdc.portal.session.query.QueryString;
import org.vamdc.portal.session.query.XSAMSQueryAdaptor;
...
public class XSAMSQueryGenerator {
	...
	public void executeQuery() {
		...
		// Removed submittedTAPQueryList from Registry Browser and placed it in 
		// Submitted Query. 
		// Should have updated the code rather than commenting it out.
		/*
		if (xsamsURL != null) {
